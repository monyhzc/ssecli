# SSECLI Skill for AI Assistants

This document describes how to integrate ssecli with AI assistants like Claude Code and OpenClaw.

## Overview

SSECLI is a command-line interface for the SSE Market forum that can be used by both humans and AI agents. This skill enables AI assistants to interact with the forum programmatically.
...
1. Create a skill file at `.trae/skills/ssecli/SKILL.md` with the following content:
...
[Copy the content from this SKILLS.md file]
```

2. Claude Code will automatically invoke this skill when the user mentions forum-related topics.

### OpenClaw Integration

Similar to Claude Code, OpenClaw can use this skill by:
1. Installing ssecli globally: `npm install -g @anthropic-ai/ssecli`
2. Creating a skill configuration file
3. Invoking ssecli commands through the skill system
